<template>
  <div class="main">
    ...
    <div>
      <div>
        <van-cell title="卖座券" icon="credit-pay">
          <template #right-icon>
            <van-icon name="arrow" />
          </template>
        </van-cell>
        <van-cell title="组合红包" icon="bill-o">
          <template #right-icon>
            <van-icon name="arrow" />
          </template>
        </van-cell>
        <van-cell title="余额" icon="balance-o">
          <template #right-icon>
            <van-icon name="arrow" />
          </template>
        </van-cell>
        <van-cell title="帮助与服务" icon="service-o">
          <template #right-icon>
            <van-icon name="arrow" />
          </template>
        </van-cell>
...
export default {
  ...
  created(){
    this.phone = this.$store.state.phone || '立即登录'
  }
};
</script>
